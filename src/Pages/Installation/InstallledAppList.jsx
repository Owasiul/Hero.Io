...
const InstallledAppList = ({ installedApps, handleUnInstall }) => {
  const { image, title, size, downloads, ratingAvg, id } = installedApps;
  return (
    <div>
      <div className="card card-side shadow-md flex items-center justify-between w-full h-fit border p-2 bg-white ">
        <div className="flex flex-row space-x-3 items-center">
          <figure className="p-4 bg-gray-200 rounded-xl">
            <img src={image} alt="Book Cover" className="w-32 rounded-md" />
          </figure>
